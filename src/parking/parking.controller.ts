// import { Controller, Get, Post, Body, Patch, Param, HttpException, HttpStatus, Put,UsePipes,ValidationPipe,} from '@nestjs/common';
...
//   @Post('parking_lot')
//   initializeParkingLot(@Body('no_of_slot') noOfSlot: number): { total_slot: number } {
//     return this.parkingService.initializeParkingLot(noOfSlot);
//   }

//   @Patch('parking_lot')
//   expandParkingLot(@Body('increment_slot') incrementSlot: number): { total_slot: number } {
//     return this.parkingService.expandParkingLot(incrementSlot);
//   }

//   @Post('park')
//   allocateParkingSlot(@Body() car: Car): { allocated_slot_number: number } {
//     return this.parkingService.allocateParkingSlot(car);
//   }

//   @Post('clear')
//   freeParkingSlot(@Body() body: { slot_number?: number; car_registration_no?: string }): { freed_slot_number: number } {
//     return this.parkingService.freeParkingSlot(body);
//   }
